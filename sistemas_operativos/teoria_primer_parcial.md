...
- [Sistema Operativo](#sistema-operativo)
  ...
  * [Clasificaciones de sistemas operativos](#clasificaciones-de-sistemas-operativos)
    + [Estructura](#estructura)
      - [Monolítica](#monol-tica)
      - [Capas](#capas)
      - [Máquina virtual](#m-quina-virtual)
      - [Cliente-Servidor](#cliente-servidor)
    + [Por modos de explotación](#por-modos-de-explotaci-n)
    + [Por servicios ofrecidos](#por-servicios-ofrecidos)
    + [Por la forma de ofrecer los servicios](#por-la-forma-de-ofrecer-los-servicios)
...
- [Procesos e hilos](#procesos-e-hilos)
  * [Proceso](#proceso)
    ...
    + [Estados de los procesos](#estados-de-los-procesos)
      - [Bloqueo](#bloqueo)
        ...
        * [Deadlock](#deadlock)
    + [Operaciones sobre procesos](#operaciones-sobre-procesos)
      - [Crear el proceso](#crear-el-proceso)
      - [Destruír un proceso](#destru-r-un-proceso)
      - [Suspender un proceso](#suspender-un-proceso)
      - [Reanudar un proceso](#reanudar-un-proceso)
      - [Temporizar la ejecución de un proceso](#temporizar-la-ejecuci-n-de-un-proceso)
      - [Despertar un proceso](#despertar-un-proceso)
    + [Prioridades](#prioridades)
      - [Prioridades asignadas por el sistema operativo](#prioridades-asignadas-por-el-sistema-operativo)
      - [Prioridades asignadas por el propietario](#prioridades-asignadas-por-el-propietario)
    + [Clasificación de procesos](#clasificaci-n-de-procesos)
      - [Procesos limitados por la entrada/salida](#procesos-limitados-por-la-entrada-salida)
      - [Procesos limitados por el CPU](#procesos-limitados-por-el-cpu)
  ...
  * [Comunicación](#comunicaci-n)
    ...
    + [Tipos de comunicación](#tipos-de-comunicaci-n)
      - [Comunicación directa](#comunicaci-n-directa)
      - [La interacción productor-consumidor](#la-interacci-n-productor-consumidor)
      - [Direccionamiento simétrico y asimétrico](#direccionamiento-sim-trico-y-asim-trico)
      - [Comunicación indirecta](#comunicaci-n-indirecta)
    + [Aspectos de la comunicación](#aspectos-de-la-comunicaci-n)
      - [Capacidad limitada y capacidad ilimitada](#capacidad-limitada-y-capacidad-ilimitada)
      - [Rendez-vous](#rendez-vous)
        * [Características:](#caracter-sticas--1)
    + [Problemas en la comunicación](#problemas-en-la-comunicaci-n)
    + [Compartir](#compartir)
      - [Sincronización de procesos](#sincronizaci-n-de-procesos)
    + [Problemas: región crítica](#problemas--regi-n-cr-tica)
  * [Calendarización](#calendarizaci-n)
    + [Niveles de planificación](#niveles-de-planificaci-n)
      - [Nivel alto](#nivel-alto)
      - [Nivel intermedio](#nivel-intermedio)
      - [Nivel bajo](#nivel-bajo)
    + [Objetivos de la planificación](#objetivos-de-la-planificaci-n)
      - [Planificación apropiativa](#planificaci-n-apropiativa)
      - [Planificación no apropiativa](#planificaci-n-no-apropiativa)
    + [Planeadores - Itineradores](#planeadores---itineradores)
      - [Itinerador de tareas](#itinerador-de-tareas)
      - [Itinerador de CPU](#itinerador-de-cpu)
