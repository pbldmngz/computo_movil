                        ...
                        <table style="width:40%; background-color: white;">
                            <tr>
                                <td colspan="2">
                                    <center>
                                        <br/>
                                        <img style=" width: 300px;" src="logo.png" align="middle"/>
                                    </center>
                                    <br/>
                                </td>
                            </tr>
                                    ...
                                    <table border="0" style="float: right;">
                                        <xsl:for-each select="mod_2">
                                            <tr>
                                                ...
                                                <td>$
                                                    <xsl:value-of select="m_total"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Pagar antes de: </td>
                                                <td>
                                                    <xsl:value-of select="m_antes"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Mes de facturación: </td>
                                                <td>
                                                    <xsl:value-of select="m_mes"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Telefono: </td>
                                                <td>
                                                    <xsl:value-of select="m_telefono"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Factura n°: </td>
                                                <td>
                                                    <xsl:value-of select="m_factura"/>
                                                </td>
                                            </tr>
                                            <tr>
                                    ...
                                    <table border="0" style="font-family: fantasy; width: 100%;">
                                        <xsl:for-each select="mod_3">
                                            ...
                                            <tr style="width: 80%;">
                                                ...
                                                <td>$
                                                    <xsl:value-of select="s_anterior"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Pago: </td>
                                                <td>$
                                                    <xsl:value-of select="s_pago"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Saldo: </td>
                                                <td>$
                                                    <xsl:value-of select="s_saldo"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Cargos del mes: </td>
                                                <td>$
                                                    <xsl:value-of select="s_cargos"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>IVA: </td>
                                                <td>$
                                                    <xsl:value-of select="s_iva"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Subtotal: </td>
                                                <td>$
                                                    <xsl:value-of select="s_sub"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Cargo por redondeo: </td>
                                                <td>$
                                                    <xsl:value-of select="s_redondeo"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Total: </td>
                                                <td>$
                                                    <xsl:value-of select="s_total"/>
                                                </td>
                                            </tr>
                                        </xsl:for-each>
                                    </table>
                                    ...
                                    <table border="0" style="font-family: fantasy; float: right; width: 80%;">
                                        <xsl:for-each select="mod_4">
                                            ...
                                            <tr>
                                                ...
                                                <td>$
                                                    <xsl:value-of select="a_planes"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Servicio local: </td>
                                                <td>$
                                                    <xsl:value-of select="a_servicio"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Tiendas TELNOR: </td>
                                                <td>$
                                                    <xsl:value-of select="a_tiendas"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Servicios especiales: </td>
                                                <td>$
                                                    <xsl:value-of select="a_especial"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Celulares: </td>
                                                <td>$
                                                    <xsl:value-of select="a_celulares"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>IEPS 3%: </td>
                                                <td>$
                                                    <xsl:value-of select="a_ieps"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Subtotal: </td>
                                                <td>$
                                                    <xsl:value-of select="a_sub"/>
                                                </td>
                                            </tr>
                                            <tr>
                                ...
                                <xsl:for-each select="mod_2">
                                    <center>
                                        <td colspan = "2">Teléfono: 
                                            <xsl:value-of select="m_telefono"/> | Pagar antes de: 
                                            <xsl:value-of select="m_antes"/> | Mes de facturación: 
                                            <xsl:value-of select="m_mes"/>
                                        </td>
                                    </center>
                                </xsl:for-each>
